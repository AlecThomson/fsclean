...
#       be modified. Perhaps there are functions that should be provided
#       Fourier the interface that are being done by hand here.
...
class FSCData(RAData.Data):
    ...
    def transform(self, im):
        """
        Transforms visibility data onto a FSCImage object by gridding and
        Fourier transformation. The transformed image will not be properly
        ...
        for i in self.iterkeys():
            ...
            for j in range(nchan):
                ...
                [guvec, gvvec, gl2vec, gdvec] = grid_tools.grid_3d(uvec, vvec,
                                               l2, dvec, du, dv, dl2, alpha, W)
                ...
                grid_tools.sample_grid(guvec, gvvec, gl2vec, gdvec,
                                       fg_slab, umin, vmin, slab_l2min, du,
                                       dv, dl2)
    ...
    def transform(self, im):
        ...
        for i in self.iterkeys():
            ...
            for j in range(nchan):
                ...
                # Convolve data vector with GCF
                [guvec, gvvec, gl2vec, gdqvec, gduvec] = \
                    grid_tools.grid_3d_pol(
